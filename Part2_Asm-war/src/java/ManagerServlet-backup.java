...
//                String validationError = validateManagerInput(request, manager.getEmail(), manager.getId());
//                if (validationError != null) {
//                    request.setAttribute("error", validationError);
//                    request.setAttribute("manager", manager);
//                    request.getRequestDispatcher("/manager/reg_edit_manager.jsp").forward(request, response);
//                    return;
//                }
//
