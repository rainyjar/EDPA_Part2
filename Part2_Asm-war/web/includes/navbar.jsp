...
<section class="navbar navbar-default navbar-static-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%= request.getContextPath()%>/DoctorHomepageServlet" class="img-responsive">
                <img src="<%= request.getContextPath()%>/images/amc_logo.png" alt="APU Medical Center Logo">
            </a>
            <% } else if (session.getAttribute("staff") != null) {%>
            <a href="<%= request.getContextPath()%>/CounterStaffServletJam?action=dashboard" class="img-responsive">
                <img src="<%= request.getContextPath()%>/images/amc_logo.png" alt="APU Medical Center Logo">
            </a>
            <% } else if (session.getAttribute("manager") != null) {%>
            <a href="<%= request.getContextPath()%>/ManagerHomepageServlet" class="img-responsive">
                <img src="<%= request.getContextPath()%>/images/amc_logo.png" alt="APU Medical Center Logo">
            </a>
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li <%= request.getServletPath().contains("TreatmentServlet") ? "class='active'" : ""%>>
                    <a href="<%= request.getContextPath()%>/TreatmentServlet?action=viewAppointmentHistory">View Appointments</a>
                </li>
                <li <%= request.getServletPath().contains("Profile") ? "class='active'" : ""%>>
                    <a href="<%= request.getContextPath()%>/Profile">Profile</a>
                </li>
                <li class="appointment-btn">
                    <a href="<%= request.getContextPath()%>/Login?logout=true" onclick="return confirmLogout();">Logout</a>
                </li>
