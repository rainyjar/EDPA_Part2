        ...
        <div class="row">
            ...
            <div class="<%= colClass %>">
                <div class="team-thumb wow fadeInUp" data-wow-delay="<%= delay %>s">
                    <img src="<%= request.getContextPath() %>images/profile_pic/<%= profilePic %>" class="img-responsive" alt="<%= doctorName %> Profile Picture">
                    <div class="team-info">
                        <h3><%= doctorName %></h3>
                        ...
                        <div class="team-contact-info">
                            ...
                            <% } %>
                            <% if (doc.getRating().doubleValue() > 0) { %>
                    ...
                    <div class="<%= colClass %>">
                        ...
                        <div class="treatments-thumb wow fadeInUp" data-wow-delay="<%= delay %>s" data-treatment-id="<%= treatment.getId() %>">
                            <div class="treatment-image clickable-treatment">
                                <img src="<%= request.getContextPath() %>/images/treatment/<%= imagePath %>" class="img-responsive" alt="<%= displayName %>">
                            </div>
