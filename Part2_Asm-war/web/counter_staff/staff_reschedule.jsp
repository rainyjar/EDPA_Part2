    ...
    <script>
        ...
        function updateStepIndicators(currentSection) {
            ...
            switch(currentSection) {
                case 'treatment-section': stepNumber = 0; break;
                case 'date-section': stepNumber = 1; break;
                case 'doctor-section': stepNumber = 2; break;
                case 'message-section': stepNumber = 3; break;
            }
